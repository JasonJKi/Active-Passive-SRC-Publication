...
function [handle,Zi,grid,Xi,Yi, plotHandle] = topoplot(Values,loc_file,varargin)
...
%%%%%%%%%%%%%%%%%%%%%% Mark electrodes of interest interest %%%%%%%%%%%%%%%%%%%%%%%%%%%%%

elseif strcmp(ELECTRODES,'mark')
    markIndex = vals;
    plotHandle = [];
    if sum(markIndex)
        plotHandle = plot(y(markIndex), x(markIndex), '*', 'MarkerEdgeColor', [0.920, 0.7, 0.12], 'MarkerSize', 5);
    end
